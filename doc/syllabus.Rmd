...
## Content
We are using an interactive platform that contains a series of slide decks accompanied by multiple-choice questions and interactive coding exercises to apply what you learned during the module: [https://ubc-mds.github.io/introduction-machine-learning](https://ubc-mds.github.io/introduction-machine-learning). We recommend using Chrome, Firefox or Safari to complete the content as other browsers are incompatible with the content platform. 
