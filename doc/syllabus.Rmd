...
Introduction to Machine Learning is part of the Key Capabilities in Data Science program. You must obtain 70% or higher in Introduction to Machine Learning to obtain a course completion grade. To successfully complete the Key Capabilities in Data Science program, you must complete all four required courses and achieve 70% or higher for each of the four courses. 
