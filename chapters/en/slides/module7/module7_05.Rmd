...
- The `.ravel()` function "flattens" or "unravels" the matrix into a 1D array which makes it easier to obtain the values which we need to explain the next concepts. 
...
```{python echo=FALSE, fig.width = 9, fig.height = 7,  out.width = '75%', fig.align='center'}
...
There is a convenient function called `classification_report` in `sklearn` which gives the information that we described above.
...
<center><img src="/module7/evaluation-metrics.png"  width = "70%" alt="404 image" /></center>
