...
```{python include=FALSE}
import graphviz
def plot_decision_tree(model, name,
              class_names=["A+", "not A+"] ):
    ...
    ).render("../../../../static/module2/module2_18" + name, format='png') 
```
...
```{python include=FALSE}
plot_decision_tree(model, 'b')
```

<center><img src="/module2/module2_18b.png"  width = "40%" alt="404 image" /></center>
...
```{python include=FALSE}
plot_decision_tree(model, 'd')
```

<center><img src="/module2/module2_18d.png"  width = "40%" alt="404 image" /></center>
...
<center><img src="/module2/generalization-train.png" width = "60%" alt="404 image" /></center>
