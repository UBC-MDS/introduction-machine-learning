...
Take note that we are passing original data to `predict` as well. This time the pipeline is carrying out the following steps:
...
<center><img src="/module5/pipeline.png" width = "90%" alt="404 image" /></center>
