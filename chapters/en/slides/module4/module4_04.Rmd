...
We could skip the 4 steps and instead use a toll from the `sklearn` library.

---

This may look familiar. That's because when we are in 2 dimensions it takes on the equation: 

<center><img src="/module4/pythagoras.gif"  width = "20%" alt="404 image" /></center>
...
<center><img src="/module4/eq3.png"  width = "25%" alt="404 image" /></center>


For vectors in 4-dimensional space: 

<center><img src="/module4/eq4.png"  width = "35%" alt="404 image" /></center>
