...
Notes: Next, let's look at the distances between City 0 and some other cities. 
...
dists[0,2]
```
We can find the most similar Pokemon from our training data to the Pokemon 1 from the test set by:
...
A numpy array with shape (9,) is 1 dimensional where as (1, 9) is 2 dimensional which is what `kneighbors()` needs as an imput. 

Now we can see that the top 5 most similar pokemon are 364,361,590 and 97 with their respective distances of 45.83, 81.88, 82.70 84.91, and 85.08.
