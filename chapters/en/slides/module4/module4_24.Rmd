...
For now, just ignore gamma input argument in `SVC()` we will get to that soon. 
...
It should come to no surprise that we can also use SVM models for regression problems as well.
...
We are not going to go into detail about the meaning behind these parameters but you should be able to explain how they effect training and testing scores (The fundamental trade-off). 
...
Best validation scores requires a hyperparameter search between both of these to balance the fundamental tradeoff.
