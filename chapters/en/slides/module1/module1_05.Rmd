...
- **Classification problem**: predicting among two or more discrete classes
    ...
    - *Example2*: Predict whether a student would get an A+ or not in this course's quiz2.
...
There are wo main kinds of supervised learning problems based on what they are trying to predict; ***Classification*** and  ***Regression***. 
...
For example: 
- housing prices
- student's score in this course's quiz2.
