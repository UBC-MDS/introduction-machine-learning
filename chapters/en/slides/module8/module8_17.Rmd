...
```{python echo=FALSE, fig.width = 10, fig.height = 8,  out.width = '50%', fig.align='center'}
...
```{python  echo=FALSE, fig.width = 13, fig.height = 8,  out.width = '58%', fig.align='center'}
...
plt.xlabel("alcohol", fontsize=16); plt.ylabel("malic_acid", fontsize=16)
plt.title("Logistic Regression - Multi Class", fontsize=18)
```
...
```{python  echo=FALSE, fig.width = 12, fig.height = 8,  out.width = '100%', fig.align='center'}
