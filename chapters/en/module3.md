...
Let's use `cross_val_score()` on a Pokémon dataset that we've used before in <a href="https://ubc-mds.github.io/programming-in-python-for-data-science/" target="_blank">Programming in Python for Data Science</a>.
