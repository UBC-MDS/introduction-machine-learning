def test():
    ...
    assert round(mean_scores.values[2],2) - 0.96 < 0.00001, "The mean test score is incorrect. Are you fitting the model correctly?"
    assert round(mean_scores.values[3],2) - 0.99 < 0.00001, "The mean training score is incorrect. Are you fitting the model correctly?"
