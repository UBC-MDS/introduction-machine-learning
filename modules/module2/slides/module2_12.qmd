...
:::{.notes} 
 When you call `fit`, a bunch of values get set, like the split variables and split thresholds.<br><br>
- These are called **parameters**.<br>

But even before calling `fit` on a specific data set, we can set some "knobs" that control the learning.<br><br>
- These are called **hyperparameters**.<br>
:::
