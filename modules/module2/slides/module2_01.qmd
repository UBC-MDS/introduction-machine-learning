...
Here is the key terminology that you will have to know:<br><br>
- **Root**: Where we start making our conditions.<br>
- **Branch**:  A branch connects to the next node (statement). Each branch represents either true or false.<br>
- **Internal node**: conditions within the tree.<br>
- **Leaf**: the value predicted from the conditions.<br>
- **Tree depth**: The longest path from the root to a leaf.<br>
