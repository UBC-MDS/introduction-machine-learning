...
For example:<br>
- Whether a patient has a liver disease or not (2 possible target values)<br>
- The letter grade of a student: A, B, C, D or F. (There are 5 categories)<br>

**Regression** predicts a continuous (typically, floating-point) value.

For example:<br>
- Housing prices<br>
- The scores of students in this course's quiz2.<br>
