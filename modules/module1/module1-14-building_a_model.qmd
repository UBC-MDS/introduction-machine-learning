...
<script>
    generateQuiz(
        ...
        { 
        'Forward': '',
        'Defense': 'We are using the strategy `most_frequent` which predicts the most frequently occuring value.',
        'Goalie': 'We are using the strategy `most_frequent` which predicts the most frequently occuring value.',
        'Player': 'We are using the strategy `most_frequent` which predicts the most frequently occuring value.',
        },
        'Forward',
    );
</script>
