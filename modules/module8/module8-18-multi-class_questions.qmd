...
assert isinstance(result, type(solution)), "If you are displaying a confusion matrix, please comment out plt.show() for checking purposes."
...
<script>
    generateQuiz(
        'mcq3',
        'Question 1',
        'Calculate the recall if <code>Other</code> is considered the positive label? <i>Remember: Recall = TP/(TP+FN)</i>',
        {
