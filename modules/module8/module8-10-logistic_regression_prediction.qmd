...
<script>
    generateQuiz(
        ...
        {
        '<code>attack</code>': 'Which feature has the greatest magnitude?',
        '<code>defense</code>': 'This feature has the highest magnitude!',
        '<code>sp_attack</code>': 'Which feature has the greatest magnitude?',
        '<code>sp_defense</code>': 'Which feature has the greatest magnitude?',
        '<code>speed</code>': 'Which feature has the greatest magnitude?',
        '<code>capture_rt</code>': 'Which feature has the greatest magnitude?',
        },
        '<code>defense</code>',
    );
</script>
...
<script>
    generateQuiz(
        ...
        {
        'Legendary': 'Did you look at the sign of the coefficient?',
        'Not Legendary': '',
        },
        'Not Legendary',
    );
