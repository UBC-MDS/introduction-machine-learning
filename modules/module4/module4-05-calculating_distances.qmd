...
<script>
    generateQuiz(
        'mcq1',
        'Question 1',
        'Given the above 2 feature vectors, what is the Euclidean distance between the above two feature vectors?',
        {
        '49': 'You forgot to square root!',
        '7': '',
        '6': 'Not quite there.',
        '36': 'Check your calculation.',
        },
        '7',
    );
</script>
...
<script>
    generateQuiz(
        'mcq2',
        'Question 2',
        'Which two vectors are most similar among <code>u</code>, <code>v</code>, and <code>w</code>?',
        {
...
assert round(result, 2) == round(solution, 2), "Check your calculation again."
print_correct_msg()
```
...
assert round(result, 2) == round(solution, 2), "Are you calculating the euclidean distance between the first 2 pokemon?"
print_correct_msg()
```
