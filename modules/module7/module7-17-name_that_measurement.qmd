...
from sklearn.svm import SVR
from sklearn.metrics import mean_squared_error, r2_score
from src.util.py import assert_accuracy_almost
...
assert list(solution.keys()) == list(result.keys()), "Have you calculated all the measurements and stored in the dict?"
