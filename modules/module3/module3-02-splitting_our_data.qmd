...
<script>
    generateQuiz(
        'mcq4',
        'Question 1',
        'If you don’t set random_state, splitting your data will be randomized and you will get different results each time.',
        {
        'True': '',
        'False': 'train_test_split() splits the given data in a randomized manner.',
        },
        'True',
    );
</script>
