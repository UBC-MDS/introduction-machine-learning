...
<script>
    generateQuiz(
        'mcq3',
        '',
        'Given this output of <code>cross_val_score()</code>, what was the value of 𝑘?',
        {
...
assert isinstance(result, np.ndarray), "Make sure you are doing cross validation scoring using the 'cross_val_score' function."
assert solution.size == result.size, "Make sure you are doing 6-fold cross validation."
assert_accuracy_almost(round(sum(solution)/solution.size,3), round(sum(result)/result.size,3), tolerance=0.015)
```
