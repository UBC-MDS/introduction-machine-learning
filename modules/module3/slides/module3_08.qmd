...
:::{.notes} 
This brings us to our standard set of steps or workflow for supervised learning.<br><br>
1. We are given the dataset with our `X` and `y`.<br>
2. We split our data into our `X_train`, `y_train`, `X_test`, y_test`.<br>
3. We try different models and hyperparameter optimization.<br>
4. We then build the best model based on the results.<br>
5. When we have our favourite model, we assess our model with our `X_test`, y_test`.<br>
