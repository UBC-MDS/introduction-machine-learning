...
:::{.notes} 
At the end of module 2, we discussed two kinds of scores (accuracies) in a model:<br><br>
1. Score on the training data<br><br>
2. Score on the entire distribution of data<br>
...
It uses useful arguments such as:<br><br>
- `test_size`<br>
- `train_size`<br>
- `random_state`
:::
...
And then we are going to pass in the `X` and the `y` to give us the 4 separate objects that we name:<br><br>
- `X_train`<br>
- `X_test`<br>
- `y_train`<br>
- `y_test`<br>
...
y_encoded_test = np.where(y_test == 'Canada', 1, 0)
